...
keeps <- c("imagenes","textos", "sonidos","videos", "urls","no_media")
mydata <- datos[keeps]
#mydata <- scale(mydata)
...
fit <- princomp(mydata, cor=TRUE, scale=FALSE)
...
result <- PCA(mydata, scale.unit = TRUE) # graphs generated automatically 
